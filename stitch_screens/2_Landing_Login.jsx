...
<a className="text-pink-500 font-bold border-b-2 border-pink-500 pb-1 font-label-caps cursor-pointer active:scale-95 transition-all duration-300" href="#">Discover</a>
...
<button className="material-symbols-outlined text-zinc-400 hover:text-white transition-all cursor-pointer">notifications</button>
<button className="material-symbols-outlined text-zinc-400 hover:text-white transition-all cursor-pointer">settings</button>
</div>
</div>
</header>
...
<button className="px-10 py-5 bg-primary-container text-white font-label-caps rounded-full shadow-[0_0_20px_rgba(255,75,137,0.3)] hover:shadow-[0_0_40px_rgba(255,75,137,0.5)] hover:scale-105 active:scale-95 transition-all duration-500 ease-out glass-noise overflow-hidden relative group">
...
<input className="w-full bg-transparent border-b-2 border-white/10 focus:border-primary py-3 outline-none font-body-md transition-all duration-500 placeholder:text-zinc-600 focus:placeholder:opacity-0 caret-primary" placeholder="name@university.edu" type="text"/>
...
<input className="w-full bg-transparent border-b-2 border-white/10 focus:border-primary py-3 outline-none font-body-md transition-all duration-500 placeholder:text-zinc-600 focus:placeholder:opacity-0 caret-primary" placeholder="••••••••" type="password"/>
<div className="absolute bottom-0 left-0 w-0 h-[2px] bg-primary transition-all duration-700 group-focus-within:w-full"></div>
</div>
...
<button className="w-full py-5 bg-on-background text-background font-bold font-label-caps rounded-xl hover:shadow-[0_0_30px_rgba(255,255,255,0.15)] active:scale-95 transition-all duration-500 custom-cubic flex items-center justify-center space-x-3">
...
<img alt="Students in Library" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" data-alt="Cinematic grayscale shot of two students working on laptops in a modern glass-walled university library with soft morning light" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAdcmhlgfcdTUo3Isbw5UDuRzyG8hPtKXQ2B5fg717CpQYElWdKeEkfkIfKtzLYXEr_JTGg62QeamrD54OWcsOMkEVWsRpOyvtUNanadKu-ilKTP5fpUr9tocd9yGjBpYMWm97CdTAcWYvSls59Iug_Xcf6HxAnljWJF4am31H2-hXUby-isepVJyKTnFt-DQO3hBObmVXbwvU9Z3QVFEMh08u1byMY8lfR6R9sK6PqsZZ2mA_oFgn_Kr5onzZQ05xtjTKM76eBfqOo"/>
...
<img alt="University Architecture" className="w-full h-full object-cover scale-110 group-hover:scale-100 transition-transform duration-[2s]" data-alt="Minimalist architectural shot of a modern glass and concrete university building with dramatic shadows at sunset" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAPnTY07JMp9vciY1rH-Bzs6WV2LFibhIst-KkIMVGuw1gVPsxp9Wxe4D-rPiyyZbDvlPpIoiP95yhhFH5PrRbFCCLVWgv6Nq8ta1T5zNdYmDq8nWLcWsNWAbeee4Cy6G6bAVfKRlflMIJFawAUE8HE9warMcNspbyFAXjQw5la9ztwXPVsZX5TWcy5sz-dqLU-Ae3kYd7G64WByBhLD1Z8G7xeBMw9evUthX_sgfP7Ecv6meL8hVdaDWHxuaGAkfyNwJdf4EEi6Hra"/>
...
{/* Bottom Navigation Hub (Mobile Only) */}
<nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-safe">
<div className="bg-zinc-900/60 backdrop-blur-3xl border border-white/20 rounded-full mb-8 mx-auto w-[90%] max-w-md h-20 flex justify-around items-center px-6 shadow-[0_0_40px_rgba(255,0,122,0.15)] shadow-2xl">
<div className="flex flex-col items-center justify-center bg-pink-500/10 text-pink-400 rounded-full px-6 py-2 shadow-[inset_0_0_12px_rgba(255,0,122,0.3)] cursor-pointer scale-110 active:scale-90 transition-all duration-500 ease-out">
...
<div className="flex flex-col items-center justify-center text-zinc-500 hover:text-pink-200 transition-colors cursor-pointer scale-110 active:scale-90 transition-all duration-500 ease-out">
